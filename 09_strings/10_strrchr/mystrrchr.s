...
myStrrchr:
	...
	label_loop_condition:
		...
		movb	12(%ebp),%al
		movl	8(%ebp),%edi
		addl	-4(%ebp),%edi		#as edi has starting address we want to store last address
		subl	$1,%edi				#edi will have null terminating character address so sub 1 to get last char address.
		movl	-4(%ebp),%ecx
		std
		repne	scasb
		cld
